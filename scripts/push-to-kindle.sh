...
KINDLE_AGENT_TITLE_ENABLED=${KINDLE_AGENT_TITLE_ENABLED:-1}
KINDLE_AGENT_TITLE_MODEL=${KINDLE_AGENT_TITLE_MODEL:-openai-codex/gpt-5.6-luna}
KINDLE_AGENT_TITLE_INTERVAL_LINES=${KINDLE_AGENT_TITLE_INTERVAL_LINES:-500}
KINDLE_AGENT_TITLE_TAIL_LINES=${KINDLE_AGENT_TITLE_TAIL_LINES:-300}
EOF
chmod 600 "$CONFIG"
